  ...
  <div class="row">
    ...
    <a href="addCourses" type="button" class="btn btn-success">Create New +</a>
      <a href="GenerateDiplomaPdf" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-right"> </span>&nbsp;Export to PDF</a>
    </div> </div><br/>
                                                       ...
                                                       ?>
                                                        <tr>
                                                           ...
                                                           <td style="width: 260px;"> <?php  echo $row['programme_req']; ?></td>
                                                            ...
                                                            <div class="btn-group">
															<a href="editDipCourseForm<?php echo'?edit_id='.$id; ?>" class="btn btn-info">Edit</a>
