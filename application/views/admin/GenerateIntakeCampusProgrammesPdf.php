...
WHERE (applicants_course_details.Campus =$campus AND applicants_course_details.intake =$sem)");
$check->execute();
...
$intakename=$semname['intake_name'];
$intname=$semname['Campus_Name'];
...
<h3 style="padding-top:0px; padding-left:4%; ">MASINDE MULIRO UNIVERSITY OF SCIENCE & TECHNOLOGY </h3>
           ...
           <div class=" row-fluid1"  style="padding-left:10%; padding-right:-5%;">
                      <hr/>  </div>
           <div class=" row-fluid1"  style="padding-left:10%; padding-right:-5%;">
                     <h3>PROGRAMMES APPLIED ON '.$intakename.' INTAKE AT '.$intname.'</h3>
                      </div>
