...
WHERE (applicants_course_details.Campus ='$campus'
    AND applicants_course_details.intake ='$sem')");
       ...
       header('Location:campus_reports');
   }
...
<?php include_once('../inc/header1.php');  ?>
  ...
  <div class="row">
	...
	<div class="row"> <div class="col-lg-4">
      <a href="GenerateIntakeCampusProgrammesPdf?intake=<?php echo $sem;?>&campus=<?php echo $campus;?>" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-right"> </span>&nbsp;Export to PDF</a>
    </div> </div><br/>

                        <div class="panel panel-primary">
                            <div class="panel-heading"><span class="glyphicon glyphicon-education"></span>&nbsp;&nbsp;CAMPUS APPLIED COURSES PER INTAKE Record list</div>
