  ...
  <div class="row">
    ...
    <a href="addCourses" type="button" class="btn btn-success">Create New +</a>
      <a href="GenerateCertificatePdf" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-right"> </span>&nbsp;Export to PDF</a>
    </div> </div><br/>

                        <div class="panel panel-primary">
                            <div class="panel-heading">Certificate Courses Record list</div>
                                                       ...
                                                       ?>
                                                        <tr>
                                                           ...
                                                           <td style="width: 260px;"> <?php  echo $row['programme_req']; ?></td>
                                                            ...
                                                            <div class="btn-group">
                                                            <a href="editCertCourseForm<?php echo'?edit_id='.$id; ?>" class="btn btn-info">Edit</a>
