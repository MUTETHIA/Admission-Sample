...
<div class="row">
 <div class="col-md-12">
              <div class="panel panel-primary">
                 <div class="panel-heading"><span class="fa fa-user"></span>&nbsp;APPLICANTS APPLIED FOR PER FACULTY IN A GIVEN INTAKE</div>
     <div class="panel-body">
                <div style="display: block;" class="box-body">
                       <h4 class="form-section">School Reports Per Faculty</h4>
                       <hr>
              <form class="form-vertical" action="applicants_per_faculty" method="get" enctype="multipart/form-data">
               <div class="col-md-4">
              ...
              <label>Faculty Name: <span class="required">*</span></label>
                <select class="form-control" required="required" id="school" name="school">
                    <option value="">~~Select Faculty Name~~</option>
                 <?php
                     $intake = $conn->prepare("SELECT * FROM faculty ORDER BY faculty_name");
                     $intake->execute();
                     while($row = $intake->fetch(PDO::FETCH_ASSOC)) { ?>
