...
<h3 style="padding-top:0px; padding-left:18%; ">MASINDE MULIRO UNIVERSITY OF SCIENCE & TECHNOLOGY </h3>
           ...
           <div class=" row-fluid1"  style="padding-left:10%; padding-right:-5%;">
                      <hr/>  </div>
           <div class=" row-fluid1"  style="padding-left:10%; padding-right:-5%;">
                     <h3>PROGRAMMES APPLIED IN <strong><i>'.$name['Level_Name'].'  Level </i></strong> INTAKE AT <strong><i>'.$name['intake_name'].'</i></strong></h3>
                      </div>
...
$mpdf->Output('Level_Intake List.pdf','I'); // For Download
exit;
?>