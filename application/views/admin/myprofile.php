          ...
          <?php
            if(isset($_POST['save_account']))
            {
              ...
              if(in_array($imgExt,$valid))
             {
                 ...
                 $stmt=$conn->prepare("UPDATE tblusers SET fname='$fname',mname='$mname',lname='$lname',email='$email',phone='$phone',photo='$imgFile' WHERE email='$session_id'");
                 $stmt->execute();
    ...
    <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-blue">
                  ...
                  <?php if($row['photo'] !=""):  ?>
                    ...
                    <?php else: ?>
                    <img src="../uploads/noimage.png" alt="Profile Picture" />
                    <?php endif; ?>
                ...
                <h3> Password Update Form</h3>
                     ...
                     if(isset($_POST['change_password']))
                     {
						...
						<strong>Sorry!</strong>  Password Doesn't match.
                         ...
                         else
                         {
                          ...
                          $stmt= $conn->prepare("UPDATE tblusers SET password='$passupdate' WHERE email='$session_id'");
                          $stmt->execute();
                          echo "<div class='alert alert-success'>
						<button class='close' data-dismiss='alert'>&times;</button>
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group has-feedback">
                      <input required  name="password" type="password" class="form-control" placeholder="Enter New Password  ">
                      <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                      <input required  name="conpassword2" type="password" class="form-control" placeholder="Enter Verify Password  ">
                      <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
